...
//       duration: '30 min', 
//       price: 'Rs.3500', 
//       description: 'A professional haircut tailored to your style, including a consultation, precision cut, and finishing touches with premium styling products.', 
...
//       duration: '2 hours', 
//       price: 'Rs.9000+', 
//       description: 'Transform your look with custom hair coloring using high-quality, long-lasting products. Includes a color consultation and post-color treatment.', 
...
//       duration: '45 min', 
//       price: 'Rs.5000', 
//       description: 'Perfect for special occasions, our styling service offers elegant updos, blowouts, or intricate styles to make you stand out.', 
...
//       duration: '1 hour', 
//       price: 'Rs.4000', 
//       description: 'Indulge in a luxurious manicure with nail shaping, cuticle care, a relaxing hand massage, and a polish of your choice.', 
...
//       duration: '1 hour', 
//       price: 'Rs.4500', 
//       description: 'Revitalize your feet with a pedicure that includes a soothing soak, exfoliation, nail care, and a hydrating massage.', 
...
//       duration: '1.5 hours', 
//       price: 'Rs.7500', 
//       description: 'Rejuvenate your skin with a facial tailored to your skin type, featuring cleansing, exfoliation, a mask, and a relaxing massage.', 
...
//   const stylists = [
//     { name: 'Emma Wilson', role: 'Hair Specialist', experience: '7+ years', image: '/images/stylist1.jpg' },
//     { name: 'Liam Carter', role: 'Color Expert', experience: '6+ years', image: '/images/stylist2.jpg' },
//     { name: 'Sophia Lee', role: 'Nail Artist', experience: '5+ years', image: '/images/stylist3.jpg' },
//     { name: 'Noah Brown', role: 'Skin Therapist', experience: '8+ years', image: '/images/stylist4.jpg' },
//     { name: 'Olivia Davis', role: 'Makeup Artist', experience: '5+ years', image: '/images/stylist5.jpg' },
//     { name: 'Ava Martinez', role: 'Hair Stylist', experience: '6+ years', image: '/images/stylist6.jpg' },
//   ];
...
//                   <span className="font-semibold text-purple-400">Duration:</span> {selectedService.duration}
//                 </p>
//                 <p className="text-gray-300 text-sm">
//                   <span className="font-semibold text-purple-400">Price:</span> {selectedService.price}
//                 </p>
...
//         <div className="max-w-7xl mx-auto">
//           <div className="text-center mb-8 sm:mb-12">
//             <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Signature Treatments</h2>
//             <p className="text-gray-400 max-w-2xl mx-auto text-sm sm:text-base">
...
//               <div key={index} className="bg-gray-800 rounded-lg sm:rounded-xl overflow-hidden hover:shadow-lg transition">
...
//                   <h3 className="text-lg sm:text-xl font-bold mb-2">{treatment.name}</h3>
//                   <p className="text-gray-400 mb-3 text-sm sm:text-base">{treatment.description}</p>
//                   <div className="flex justify-between items-center">
//                     <span className="text-purple-400 font-medium">{treatment.price}</span>
//                     <Link 
//                       to="/book-now" 
...
//           <div className="text-center mb-8 sm:mb-12">
//             <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Discover Our Salon</h2>
//             <p className="text-gray-400 max-w-2xl mx-auto text-sm sm:text-base">
...
//             <picture>
//               <source srcSet="/images/salon-tour-fallback.webp" media="(max-width: 640px)" />
//               <video
//                 autoPlay
//                 loop
//                 muted
...
//         <div className="max-w-7xl mx-auto">
//           <div className="text-center mb-8 sm:mb-12">
//             <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Meet Our Master Stylists</h2>
//             <p className="text-gray-400 max-w-2xl mx-auto text-sm sm:text-base">
//               Our talented team of professionals is ready to create your perfect look
//             </p>
//           </div>
...
//                 >
//                   <div className="bg-gray-700 rounded-lg sm:rounded-xl overflow-hidden text-center transition transform hover:scale-105">
...
//                       <p className="text-purple-400 text-sm mb-2">{stylist.role}</p>
...
//         <div className="max-w-7xl mx-auto">
//           <div className="text-center mb-8 sm:mb-12">
//             <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Transformations</h2>
//             <p className="text-gray-400 max-w-2xl mx-auto text-sm sm:text-base">
...
//           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
//             {[1, 2, 3].map((item) => (
//               <div key={item} className="bg-gray-700 rounded-lg sm:rounded-xl overflow-hidden">
//                 <div className="relative h-48 sm:h-56">
//                   <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/70 flex items-end p-4">
//                     <div>
//                       <h3 className="font-bold text-white">{['Hair Makeover', 'Bridal Styling', 'Skin Treatment'][item-1]}</h3>
//                       <p className="text-purple-300 text-sm">Client #{item}</p>
//                     </div>
//                   </div>
//                   <img 
//                     src={`/images/haircut-${item}.jpg`} 
...
// Stylist data with images (replace with your actual image paths)
const stylists = [
  {
    id: 1,
    name: "Alex Morgan",
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {services.map(service => (
              <div 
                key={service.name}
                className={`bg-gray-700 rounded-lg sm:rounde d-xl p-4 sm:p-6 cursor-pointer transition-all ${activeService === service.name ? 'border-l-4 border-purple-500 sm:transform sm:scale-105' : 'hover:bg-gray-600'}`}
                onClick={() => {
                  setActiveService(service.name);
                  setSelectedService(service);
                }}
      ...
      {/* Enhanced Stylist Showcase Section with Auto-Slide */}
      <section className="py-12 sm:py-16 px-4 sm:px-6 bg-gray-800 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <motion.h2 
              ...
              >
                {stylists.map((stylist) => (
                  <motion.div
                    ...
                    className={`w-full ${isMobile ? 'min-w-full' : 'min-w-[calc(25%-16px)]'} px-2`}
                  >
                    <div className="bg-gray-700 rounded-lg sm:rounded-xl overflow-hidden text-center hover:shadow-lg hover:shadow-purple-500/20 transition-all duration-300">
                      ...
                      <div className="p-4">
                        <h3 className="font-bold mb-1">{stylist.name}</h3>
                        <p className="text-purple-400 text-sm mb-2">{stylist.specialty}</p>
                        <p className="text-gray-400 text-xs">{stylist.experience}</p>
                      </div>
                    </div>
                  </motion.div>
          ...
          <div className="flex justify-center mt-6 space-x-2">
            {Array.from({ length: isMobile ? stylists.length : stylists.length - 3 }).map((_, index) => (
              <button
                key={index}
                onClick={() => {
                  pauseAutoSlide();
                ...
                className={`w-2 h-2 rounded-full transition-all ${currentStylistIndex === index ? 'bg-purple-500 w-4' : 'bg-gray-600'}`}
